...
{/* 
      ...
      <div class="text-xs">
        <div class="flex flex-row">
          ...
          {/* <!-- Empty Star SVG --> */}
          <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-yellow-200" viewBox="0 0 20 20" fill="currentColor">
            <path d="M9.049 2.927c.3-.916 1.603-.916 1.902 0l1.286 3.953a1.5 1.5 0 001.421 1.033h4.171c.949 0 1.341 1.154.577 1.715l-3.38 2.458a1.5 1.5 0 00-.54 1.659l1.286 3.953c.3.916-.757 1.67-1.539 1.145l-3.38-2.458a1.5 1.5 0 00-1.76 0l-3.38 2.458c-.782.525-1.838-.229-1.539-1.145l1.286-3.953a1.5 1.5 0 00-.54-1.659l-3.38-2.458c-.764-.561-.372-1.715.577-1.715h4.171a1.5 1.5 0 001.421-1.033l1.286-3.953z" />
          </svg>
        </div>
      </div>
   ...
   {   /* .......card-2....... */}
    ...
    <div class="flex flex-row justify-between w-full">
      <div class="flex flex-row justify-between w-full">
        {/* <!-- User's name --> */}
        <p class="text-lg font-semibold">sachin sn</p>
        {/* <!-- Date of the review --> */}
        <p class="text-xs">june 1, 2000</p>
      </div>
    </div>
...
{/* 
  ...
  {   /* .......card-3....... */}
    ...
    <div class="flex flex-row justify-between w-full">
      <div class="flex flex-row justify-between w-full">
        {/* <!-- User's name --> */}
        <p class="text-lg font-semibold">piyush pn</p>
        {/* <!-- Date of the review --> */}
        <p class="text-xs">june 1, 2000</p>
      </div>
    </div>
...
{/* 
  ...
  {   /* .......card-4....... */}
    ...
    <div class="flex flex-row justify-between w-full">
      <div class="flex flex-row justify-between w-full">
        {/* <!-- User's name --> */}
        <p class="text-lg font-semibold">sumit sm</p>
        {/* <!-- Date of the review --> */}
        <p class="text-xs">june 1, 2000</p>
      </div>
    </div>
...
{/* 
 ...
 {   /* .......card-5....... */}
    ...
    <div class="flex flex-row justify-between w-full">
      <div class="flex flex-row justify-between w-full">
        {/* <!-- User's name --> */}
        <p class="text-lg font-semibold">Nilam prajapati</p>
        {/* <!-- Date of the review --> */}
        <p class="text-xs">june 1, 2000</p>
      </div>
    </div>
...
{/* 
   ...
   {   /* .......card-6....... */}
    ...
    <div class="flex flex-row justify-between w-full">
      <div class="flex flex-row justify-between w-full">
        {/* <!-- User's name --> */}
        <p class="text-lg font-semibold">Ankit ak</p>
        {/* <!-- Date of the review --> */}
        <p class="text-xs">june 1, 2000</p>
      </div>
    </div>
