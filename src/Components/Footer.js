      ...
      <footer className=" footer container-fluid mx-auto py-8 bg-black text-white ">
        <div className="grid grid-cols-2 md:grid-cols-3 p-4 lg:grid-cols-6 gap-4">
          ...
          <div className="col-span-1 md:col-span-1 text-center md:text-left">
            ...
            <ul className="leading-8">
              <li >
                <a href="/" className=" text-red-500 font-semibold hover:font-semibold    hover:text-white ">
                  Equity Charges
                </a>
              </li>
        ...
        <div className="container mx-auto p-4 text-center lg:text-left md:text-left">
          <p>
            ...
            transactions in your trading and Demat account. Update your mobile
            numbers/email IDs with Tradingbells. Receive alerts and information
            of all debit and other important transactions in your trading and
            Demat account directly from Exchange/Depository on your mobile/email
